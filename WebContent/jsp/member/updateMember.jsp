	...
	<div class="con">
		...
		<div class="join-body">
			<form class="member-join" method="POST" action="doUpdateMember" onsubmit="submitJoinForm(this); return false;">
				<div class="join-loginId"><span>ID</span> <span><%=loggedInMember.getLoginId() %></span></div>
				...
				<div class="join-name"><span>이름</span> <span> <%=loggedInMember.getName() %></span></div>
				<div class="join-nickname"><span>닉네임</span> <span><%=loggedInMember.getNickname() %></span></div>
				<div class="join-email"><span>이메일</span> <span><%=loggedInMember.getEmail() %></span></div>
